...
class TestOrganizationService(unittest.TestCase):
    ...
    @mock.patch('domain.github.GithubClient.get_commits')
    def test_github_pull_request_update(self, mock_commits):
        mock_return_value = [
            {
                "sha": "ec26c3e57ca3a959ca5aad62de7213c562f8c821",
                "node_id": "MDY6Q29tbWl0MTg2ODUzMDAyOmVjMjZjM2U1N2NhM2E5NTljYTVhYWQ2MmRlNzIxM2M1NjJmOGM4MjE=",
                "commit": {
                    "author": {
                        "name": "Codertocat",
                        "email": "21031067+Codertocat@users.noreply.github.com",
                        "date": "2019-05-15T15:20:30Z"
                    },
                    "committer": {
                        "name": "Codertocat",
                        "email": "21031067+Codertocat@users.noreply.github.com",
                    ...
                    "tree": {
                        "sha": "31b122c26a97cf9af023e9ddab94a82c6e77b0ea",
                        "url": "https://api.github.com/repos/Codertocat/Hello-World/git/trees/31b122c26a97cf9af023e9ddab94a82c6e77b0ea"
                    },
                    "url": "https://api.github.com/repos/Codertocat/Hello-World/git/commits/ec26c3e57ca3a959ca5aad62de7213c562f8c821",
                    "comment_count": 0,
                    "verification": {
                        "verified": False,
                        "reason": "unsigned",
                ...
                "html_url": "https://github.com/Codertocat/Hello-World/commit/ec26c3e57ca3a959ca5aad62de7213c562f8c821",
                "comments_url": "https://api.github.com/repos/Codertocat/Hello-World/commits/ec26c3e57ca3a959ca5aad62de7213c562f8c821/comments",
                "author": {
                    "login": "Codertocat",
                    "id": 21031067,
        ...
        mock_commits.return_value = mock_return_value
        ...
        mock_commits.return_value = mock_return_valu1e1
        github_client = GithubClient()
        pull_request = GitHubPullRequestFactory(github_client).create_pull_request(pull_request_webhooh_payload)
        self.pull_request_repo.save_or_update_pull_request(pull_request)
        pull_request_db = self.pull_request_repo.get_pull_requests(pull_request.pull_request_id,
        ...
        assert len(pull_request_db[0].commits) == 2
